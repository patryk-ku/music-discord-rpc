...
Available music player icons: `Amberol`, `Audacious`, `Elisa`, `Finamp`, `Firefox`, `fooyin`, `Gelly`, `GNOME Music`, `Google Chrome`, `Lollypop`, `Mozilla Firefox`, `mpv`, `Plexamp`, `Spotify`, `Strawberry`, `Tauon`, `TIDAL Hi-Fi`, `VLC Media Player`, `YouTube`, `Zen Browser`.
...
Icons are available for these ids: `amberol`, `audacious`, `chrome`, `elisa`, `finamp`, `firefox`, `fooyin`, `gelly`, `lollypop`, `mozilla_firefox`, `mozilla_zen`, `mpv`, `music`, `plexamp`, `spotify`, `strawberry`, `tauon`, `tidalhifi`, `vlc_media_player`, `youtube`.
